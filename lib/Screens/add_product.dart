  ...
  void didChangeDependencies() {
    if (_isInside) {
      ...
      if (productId != null) {
        ...
        dateController.text = _editedProduct.expDate!;
        date1Controller.text = "2022/1/16";
        date2Controller.text = "2022/1/23";
        date3Controller.text = "2022/1/30";
      }
    }
    _isInside = false;
